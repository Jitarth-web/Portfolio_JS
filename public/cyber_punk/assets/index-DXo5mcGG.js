...
void main() {
	...
	`}var Ss=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=ur.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=ur.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=ur.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=ur.toHalfFloat(1)},c=new Uint8Array(e);c.pos=0;let l=r(c),u=l.width,d=l.height,f=i(c.subarray(c.pos),u,d),p,m,h;switch(this.type){case g:h=f.length/4;let e=new Float32Array(h*4);for(let t=0;t<h;t++)a(f,t*4,e,t*4);p=e,m=g;break;case _:h=f.length/4;let t=new Uint16Array(h*4);for(let e=0;e<h;e++)o(f,e*4,t,e*4);p=t,m=_;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:u,height:d,data:p,header:l.string,gamma:l.gamma,exposure:l.exposure,type:m,colorSpace:Be,minFilter:s,magFilter:s,generateMipmaps:!1,flipY:!0}}setDataType(e){return this.type=e,this}},ud=class extends ld{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},dd={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},fd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},pd=new vo(-1,1,1,-1,0,1),md=new class extends kr{constructor(){super(),this.setAttribute(`position`,new _r([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new _r([0,2,0,0,2,0],2))}},hd=class{constructor(e){this._mesh=new ti(md,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,pd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},gd=class extends fd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof _a?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ma.clone(e.uniforms),this.material=new _a({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new hd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},_d=class extends fd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},vd=class extends fd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},yd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new Gt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new gd(dd),this.copyPass.material.blending=0,this.timer=new ko}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}_d!==void 0&&(r instanceof _d?n=!0:r instanceof vd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},bd=class extends fd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new X}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},xd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
  ...
  `},wd=new An,Td=new An,Ed=new vo(-window.innerWidth/2,window.innerWidth/2,window.innerHeight/2,-window.innerHeight/2,-10,10);Ed.position.z=5;var Dd=new po(75,window.innerWidth/window.innerHeight,.1,1e3);Dd.position.set(0,0,3);var Od=new ou({canvas:document.getElementById(`cybercanvas`),antialias:!0,alpha:!0});Od.setClearColor(0,0),Od.setPixelRatio(Math.min(window.devicePixelRatio,2)),Od.setSize(window.innerWidth,window.innerHeight),Od.toneMapping=4,Od.toneMappingExposure=1;var kd=new xo(16777215,.1);wd.add(kd);var Ad=new bo(16777215,.4);Ad.position.set(0,2,4),wd.add(Ad);var jd=new _o(16770560,5,25);jd.position.set(2,2,1.5),wd.add(jd);var Md=new _o(61695,4,25);Md.position.set(-2,1,1.5),wd.add(Md);var Nd=new _o(16711765,3,25);Nd.position.set(0,-2,1.5),wd.add(Nd);var Pd=new yd(Od,new Gt(window.innerWidth,window.innerHeight,{samples:4}));Pd.setPixelRatio(Math.min(window.devicePixelRatio,2));var Fd=new bd(wd,Dd);Pd.addPass(Fd);var Id=new gd(Cd);Id.uniforms.amount.value=.05,Pd.addPass(Id);var Ld=new Sd;Pd.addPass(Ld),new ud().load(`./pedestrian_overpass_1k.hdr`,e=>{e.mapping=303,wd.environment=e,console.log(`HDRI Environment loaded successfully!`)});var Rd=null;new uu().load(`./DamagedHelmet.gltf`,e=>{Rd=e.scene,Rd.scale.set(1.5,1.5,1.5),wd.add(Rd),console.log(`GLTF Model loaded successfully!`)},e=>{console.log(`Loading model: ${(e.loaded/e.total*100).toFixed(2)}%`)},e=>{console.error(`Error loading GLTF model:`,e)}),new $a().load(`./cyberpunk_logo.png`,e=>{let t=new _a({uniforms:{tDiffuse:{value:e}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthTest:!1,depthWrite:!1,blending:1}),n=e.image?e.image.width:800,r=e.image?e.image.height:250,i=Math.min(window.innerWidth*.9,1200)/n,a=new ti(new ca(n*i,r*i*1.15),t);a.position.set(0,0,0),Td.add(a),Td.userData.logoPlane=a,Td.userData.baseWidth=n,Td.userData.baseHeight=r}),window.addEventListener(`resize`,()=>{if(Dd.aspect=window.innerWidth/window.innerHeight,Dd.updateProjectionMatrix(),Ed.left=-window.innerWidth/2,Ed.right=window.innerWidth/2,Ed.top=window.innerHeight/2,Ed.bottom=-window.innerHeight/2,Ed.updateProjectionMatrix(),Td.userData.logoPlane){let e=Td.userData.logoPlane,t=Td.userData.baseWidth,n=Td.userData.baseHeight,r=Math.min(window.innerWidth*.9,1200)/t;e.geometry.dispose(),e.geometry=new ca(t*r,n*r*1.15)}Od.setSize(window.innerWidth,window.innerHeight),Od.setPixelRatio(Math.min(window.devicePixelRatio,2)),Pd.setSize(window.innerWidth,window.innerHeight),Pd.setPixelRatio(Math.min(window.devicePixelRatio,2))}),window.addEventListener(`mousemove`,e=>{Rd&&(Rd.rotation.y=(e.clientX/window.innerWidth-.5)*Math.PI*.4,Rd.rotation.x=(e.clientY/window.innerHeight-.5)*Math.PI*.25)});var zd=()=>{requestAnimationFrame(zd),Pd.render(),Od.autoClear=!1,Od.render(Td,Ed),Od.autoClear=!0};zd();