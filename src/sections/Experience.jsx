        ...
        <div className="experience-timeline relative mt-16 pl-8 md:pl-0">
          ...
          <div className="flex flex-col gap-12">
            {experience.map((item, index) => {
              ...
              if (index === 0) {
                imgSrc = astronaut;
                imgClass = "absolute right-[-15%] md:right-[-20%] top-[-25%] w-40 md:w-56 z-[-1]";
                floatClass = "float-anim-1";
              } else if (index === 1) {
                imgSrc = image34;
                imgClass = "absolute left-[-15%] md:left-[-20%] bottom-[5%] w-32 md:w-48 z-[-1]";
                floatClass = "float-anim-2";
              } else if (index === 2) {
                imgSrc = image35;
                imgClass = "absolute right-[-15%] md:right-[-20%] bottom-[-15%] w-36 md:w-52 z-[-1]";
